...
public interface ILoginService {
    ...
    @RequestWrapper(localName = "SolicitarAutorizacion", targetNamespace = "http://ISTP1.Service.Contracts.Service", className = "Wrapper.SolicitarAutorizacion")
    @ResponseWrapper(localName = "SolicitarAutorizacionResponse", targetNamespace = "http://ISTP1.Service.Contracts.Service", className = "Wrapper.SolicitarAutorizacionResponse")
